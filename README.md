## i think this repo exists

This repository contains the public FTC SDK for the DECODE (2025-2026) competition season.

## WELCOME!
This GitHub repository doesn't contain the source code that is used to build an Android app to control a *FIRST* Tech Challenge competition robot.  To use this SDK, DO NOT download/clone the entire project to your local computer.
